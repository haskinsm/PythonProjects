# -*- coding: utf-8 -*-
"""
Created on Fri Jan 14 18:19:21 2022
...
class CensusIncome():
    ...
    dataFilesDir = os.path.join(currentDir, "scripts_and_data\\data\\datasets\\income_data\\processed_data.csv")
    ...
    TARGET_VAR_NAME = "income" # name of target variable column
